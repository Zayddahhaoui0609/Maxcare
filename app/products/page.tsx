...
const collections = ['All', 'Argan Oil', 'Caviar', 'Luxury Argan Oil', 'Hair Treatment'];
const categories = ['All', 'Hair Serum', 'Shampoo', 'Conditioner', 'Hair Mask', 'Hair Treatment', 'Youth Oil'];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16 page-title">
          ...
          <p className="text-sm sm:text-base lg:text-lg text-luxury-brown-600 max-w-2xl mx-auto px-4">
            Discover premium hair care products crafted with pure Moroccan Argan oil
            and Golden Caviar for exceptional results.
          </p>
        </div>
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex items-center justify-center gap-2 mb-3">
            ...
            <span className="font-semibold text-sm sm:text-base text-luxury-brown-800">Collections:</span>
          </div>
        ...
        <div className="mb-8 sm:mb-12">
          <div className="flex items-center justify-center gap-2 mb-3">
            <Filter size={16} className="sm:w-[18px] sm:h-[18px]" />
            <span className="font-semibold text-sm sm:text-base text-luxury-brown-800">Product Type:</span>
          </div>
          <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-3">
